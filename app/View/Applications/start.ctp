<div class="span12">
	...
	<div class="row-fluid">
		<div class="span6">
			<?php echo $this->Form->input('semester_id',array('label'=>'Expected entrance term <a href="/test" class="labeltooltip" data-toggle="tooltip" data-placement="top" title data-original-title="Please choose the semester you would like to begin attending CFNI"><i class="icon-question-sign"></i></a>','options'=>$semesters,'empty'=>'--','class'=>'span12')); ?>
		</div>
		<div class="span6">
