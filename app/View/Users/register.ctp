<div class="span6 offset3">
	<div class="well">
		...
		<p>Please fill in the following form to create an account. Once you have submitted this form, you receive an email that contains a link to confirm your account.</p>
		<?php
